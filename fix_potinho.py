...
# The block starts with this comment and ends before "    </div>\n  </section>" of the cards section
...
# Remove everything from start_marker to the closing divs, replace with just the closing divs
